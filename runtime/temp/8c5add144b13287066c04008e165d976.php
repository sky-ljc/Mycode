<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"D:\PHPTutorial\WWW\boke\Public/../application/home\view\index\index-nosidebar.html";i:1525349783;s:62:"D:\PHPTutorial\WWW\boke\Application\home\view\public\head.html";i:1524830915;s:61:"D:\PHPTutorial\WWW\boke\Application\home\view\public\nav.html";i:1526302219;s:60:"D:\PHPTutorial\WWW\boke\Application\home\view\public\js.html";i:1524830664;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="am-g am-g-fixed blog-fixed am-u-sm-centered blog-article-margin">
    <div data-am-widget="slider" class="am-slider am-slider-b1" data-am-slider='{&quot;controlNav&quot;:false}' >
        <ul class="am-slides" id="banner">
            <?php foreach($banners['pic_img'] as $bk=>$bv): ?>
            <li>
                <img src="/uploads/<?php echo $bv; ?>" style="width:1164px;height: 503px;">
                <div class="blog-slider-desc am-slider-desc ">
                    <div class="blog-text-center blog-slider-con">
                        <span><a href="<?php echo url('Index/detail',['id'=>$hotart[$bk]['id']]); ?>" class="blog-color">Article &nbsp;</a></span>
                        <h1 class="blog-h-margin"><a href="<?php echo url('Index/detail',['id'=>$hotart[$bk]['id']]); ?>"><?php echo $hotart[$bk]['tag_title']; ?>
                        </a></h1>
                        <p><?php echo $hotart[$bk]['tag_content']; ?>...
                        </p>
                        <span class="blog-bor"><?php echo date('Y/m/d',$hotart[$bk]['tag_addtime']); ?></span>
...
<div class="am-g am-g-fixed blog-fixed">
    <div class="am-u-md-12 am-u-sm-12" id="isarticle">
            ...
            success :function (res) {
                if(res.code==2000){
                    ...
                    $.each(res.data,function (index,val) {
                        ...
                        article+='<article class="am-g blog-entry-article newarticle"><div class="am-u-lg-6 am-u-md-12 am-u-sm-12"><img src="/article/'+val.tag_img+'" alt="'+val.tag_key+'" class="am-u-sm-12"></div>';
                ...
                $.ajax({
                    ...
                    success :function (res) {
                        if(res.code==2000){
                            ...
                            $.each(res.data,function (index,val) {
                                var url = '<?php echo url("Index/detail"); ?>?id='+val.id;
                                article+='<article class="am-g blog-entry-article"><div class="am-u-lg-6 am-u-md-12 am-u-sm-12"><img src="/article/'+val.tag_img+'" alt="'+val.tag_key+'" class="am-u-sm-12"></div>';
                                article+='<div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-text"><span><a href="'+url+'" class="blog-color">article&nbsp;</a></span><span>@'+val.username+' &nbsp;</span><span>'+val.tag_addtime+'</span>';
                                article+='<h1><a href="'+url+'">'+val.tag_title+'</a></h1>';
                                article+='<p>'+val.tag_content+'</p><p><a href="" class="blog-continue">continue</a></p></div></article>';
                            });
