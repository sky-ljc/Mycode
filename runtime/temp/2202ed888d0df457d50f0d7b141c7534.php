<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\PHPTutorial\WWW\boke\Public/../application/home\view\img\img.html";i:1525853050;s:62:"D:\PHPTutorial\WWW\boke\Application\home\view\public\head.html";i:1524830915;s:61:"D:\PHPTutorial\WWW\boke\Application\home\view\public\nav.html";i:1526302219;}*/ ?>
<!doctype html>
<html>
...
<div class="am-g am-g-fixed blog-fixed blog-content">
  <figure data-am-widget="figure" class="am am-figure am-figure-default "   data-am-figure="{  pureview: 'true' }">
      <div id="container">
          <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if(is_array($v['pic_img']) || $v['pic_img'] instanceof \think\Collection || $v['pic_img'] instanceof \think\Paginator): $kk = 0; $__LIST__ = $v['pic_img'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($kk % 2 );++$kk;?>
                 <div><img src="/uploads/<?php echo $vv; ?>"><h3><?php echo $v['pic_name']; ?><?php echo $kk; ?></h3></div>
...
<script src="/static/home/assets/js/pinto.min.js"></script>
<script src="/static/home/assets/js/img.js"></script>
</body>
</html>
